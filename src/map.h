...
class Map
{
    ...
    bool loadDungeon(const std::string& identifier, const Position& pos = Position(), bool unload = false, bool lua = false, DungeonInstance* instance = nullptr, uint8_t difficulty = 1);
