...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaPlayerGetHuntingTask(lua_State* L);
		static int luaPlayerGetHuntingTasks(lua_State* L);
		static int luaPlayerSetHuntingTaskStatus(lua_State* L);
		static int luaPlayerResetHuntingTaskCreatures(lua_State* L);
		static int luaPlayerAddHuntingTaskCreature(lua_State* L);
		static int luaPlayerSetHuntingTaskCreature(lua_State* L);
		static int luaPlayerSetHuntingTaskStars(lua_State* L);
		static int luaPlayerSetHuntingTaskAmount(lua_State* L);
		static int luaPlayerSetHuntingTaskKills(lua_State* L);
