...
void Game::loadDungeon(const std::string& path, const Position& pos, bool unload, bool lua, DungeonInstance* instance, uint8_t difficulty)
{
	map.loadDungeon(path, pos, unload, lua, instance, difficulty);
}
