...
class Game
{
	public:
		...
		void loadDungeon(const std::string& path, const Position& pos = Position(), bool unload = false, bool lua = false, DungeonInstance* instance = nullptr, uint8_t difficulty = 1);
